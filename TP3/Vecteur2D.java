...
public class Vecteur2D
{
    ...
    /**
     * Le constructeur par défaut initialise les deux composants du vecteur à zéro
     */
    public Vecteur2D()
    {
    ...
    */ 
    ...
    /**
     * Cette méthode ajoute au vecteur courant le vecteur placé en paramètre.
    ...
    /**
     * Cette méthode retourne la norme du vecteur, c'est à dire la racine carré de la somme de carrés des deux 
     * composantes du vecteur 
     * @return  la norme du vecteur 
     */
    public float getMagnitude()
    {
        // la méthode sqrt du package Math retourne un double : le transtype en float
        return (float) Math.sqrt (m_u*m_v+m_v*m_v);
    }
}
